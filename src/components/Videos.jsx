  ...
  const VideoCard = ({ video, index }) => {
    ...
    const handleVideoClick = (e) => {
      ...
      if (isPlaying) {
        ...
        // Play this video (automatically pauses others)
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-100 h-full flex flex-col">
        ...
        <div className="relative aspect-video bg-black overflow-hidden">
          ...
          {!isPlaying && !videoError && (
            <div className="absolute inset-0 bg-black/30 flex items-center justify-center cursor-pointer" onClick={(e) => handleVideoClick(e)}>
              <div className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-all duration-300">
        ...
        <div className="p-8 flex-1 flex flex-col">
          ...
          <div className="space-y-3">
            <button 
              onClick={(e) => {
                e.stopPropagation();
                const message = `Hi! I loved your ${video.title} video! I'd like to discuss a project for my brand.`;
                const whatsappUrl = `https://wa.me/9779763219914?text=${encodeURIComponent(message)}`;
                window.open(whatsappUrl, '_blank');
              }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-dark mb-4">
            My <span className="text-primary">Videos</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Creative video content showcasing my work in digital marketing and brand collaborations
          </p>
        ...
        <motion.div
          className="bg-gradient-to-r from-primary to-accent rounded-2xl p-6 sm:p-8 mt-12 sm:mt-16 mb-6 sm:mb-8 text-center text-white"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
